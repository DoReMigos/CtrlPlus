                                                      ...
                                                      return (
                                                          <>
                                                              <div key={`userCart${index}`} id="routinesContainers">
                                                                  ...
                                                                  <h4 id="subTitles">Here's your Cart  <h3>{element.userName}!</h3></h4>
                                                                      ...
                                                                      return (
                                                                          <>
                                                                              <div key={`myroutines${index}`}>
                                                                                  <h2 id='MyTitle'>{product.title}</h2>
                                                                                  <h4 id='subTitles'>Brand: {product.brand}</h4>
                                                                                  <h5 id='subTitles'></h5>
                                                                                  ...
                                                                                  <h5 id='subTitles'>Order ID: {product.order_id} </h5>
                                                                                  <div
                                                                                      ...
                                                                                      <div className='row mb-4 d-flex justify-content-between align-items-center'>
                                                                                          ...
                                                                                          <div className='col-md-3 col-lg-3 col-xl-2 d-flex'>
                                                                                              <div styles='width: 50px;'>
                                                                                                  <h5 className='fw-normal mb-0'>`Quantity: ${product.quantity}`</h5>
                                                                                              </div>
                                                                                          </div>
